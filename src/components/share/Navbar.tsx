            ...
            <ul className="lg:flex gap-x-4 max-lg:space-y-3">
              ...
              {navLinks.map((navlink) => (
                ...
                >
                  <Link
                    href={navlink.path}
                    className={`hover:text-blue-700 block font-medium text-[15px] capitalize ${
            ...
            {session && (
              <>
                <form action={logoutAction}>
                  <button
                    type="submit"
                    className="px-4 py-2 text-sm rounded-full font-medium cursor-pointer tracking-wide text-white border border-red-400 bg-red-400 hover:bg-red-500 transition-all"
                  >
                    Sign Out
                  </button>
                </form>
